...
var CollectionCard = [
	...
	{"id":12, "type": "tower", "cardName" : "Area Tower", "desc":"A tower that damages everything in it's range", "sprite": "res://Assets/Sprites/Cards/Tower/IceAreaT.png", "cost":50, "range": 125, "damage": 1, "attackSpeed": 1, "accuracy": 0.7, "unlocked": 1, 'path':'res://Prefabs/Towers/all_in_range_tower.tscn'},
