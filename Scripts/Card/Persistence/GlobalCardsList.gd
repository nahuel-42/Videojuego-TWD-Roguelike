...
var CollectionCard = [
	...
	################# SPECIALITY ####################
	{"id": 6, "type": "speciality", "cardName": "Speciality", "desc": "Data", "sprite": "res://Assets/Sprites/Speciality/Specialization.png", "texture": "res://Assets/Sprites/Enemy/Orc Crew/Orc - Shaman/Idle/Idle-Sheet.png", "cost": 100, "unlocked": 1, 'path':"res://Prefabs/Specialities/Hunter.tscn"},
	################# UPGRADES ####################
	{"id": 7, "type": "upgrade", "cardName": "Damage++", "desc": "Data", "sprite": "res://Assets/Sprites/Cards/Upgrade/Damage.png", "cost": 100, "unlocked": 1, "range": 0, "damage": 1, "attack_speed": 0, "accuracy": 0},
	...
	{"id": 9, "type": "upgrade", "cardName": "Attack speed++", "desc": "Data", "sprite": "res://Assets/Sprites/Cards/Upgrade/Attack speed.png", "cost": 100, "unlocked": 1, "range": 0, "damage": 0, "attack_speed": 0.1, "accuracy": 0},
	...
	################# Spell ####################
	{"id":14, "type": "spell", "cardName" : "Campament destruction", "desc":"", "sprite": "res://Assets/Sprites/Cards/Spell/CampDestruction.png", "cost":0, "range": 0, "damage": 0, "attackSpeed": 0, "accuracy": 0, "unlocked": 1, 'path':''},
	{"id":15, "type": "spell", "cardName" : "Tower removal", "desc":"", "sprite": "res://Assets/Sprites/Cards/Spell/TowerRemoval.png", "cost":0, "range": 0, "damage": 0, "attackSpeed": 0, "accuracy": 0, "unlocked": 1, 'path':''},
	{"id":16, "type": "spell", "cardName" : "Fireball", "desc":"", "sprite": "res://Assets/Sprites/Cards/Spell/Fireball.png", "cost":0, "range": 0, "damage": 0, "attackSpeed": 0, "accuracy": 0, "unlocked": 1, 'path':''},
	{"id":17, "type": "spell", "cardName" : "Iceball", "desc":"", "sprite": "res://Assets/Sprites/Cards/Spell/Iceball.png", "cost":0, "range": 0, "damage": 0, "attackSpeed": 0, "accuracy": 0, "unlocked": 1, 'path':''},
]
